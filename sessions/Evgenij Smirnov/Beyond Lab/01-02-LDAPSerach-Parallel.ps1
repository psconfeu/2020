...
$NumberOfThreads = [math]::Max($ous.Count, [int]$env:NUMBER_OF_PROCESSORS+1) # sweet spot vs. number of OUs
...
if ($results.Count -gt 0) {
    [System.IO.File]::WriteAllLines("Z:\temp\ldap_para_dist_aduser.txt",$results,[System.Text.Encoding]::UTF8)
}
